...
This repository contains source files, needed in order to modify the LPA's design. In order to obtain the minimum necessary files for building and using an LPA, click [here](https://github.com/taborlab/LPA-hardware/releases/download/v1.1/lpa.zip).
...
### Contents:
* CAD Files: Design files for the different parts of the LPA. Contains:
