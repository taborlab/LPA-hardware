...
On the back of the indicator LEDs is a "T" feature which indicates polarity. Confusingly, even though all three indicator LEDs are from the same manufacturer, the graphic is not consistent in indicating the orientation.
For LPA v1.0 green (475-1410-1-ND) and yellow (475-2560-1-ND) GND (bottom of the  should be on the side of the dot, while for red (475-1415-1-ND) anode should be on the side of the dot.
For LPA v1.1, the silkscreen has nubs indicating which side the bottom of the "T" goes.     
...
##### Q: For LPA v1.0, I'm having difficulty determining the polarity of the resonator. There is an input and output on the ends (leading me to think this is a component with directionality), with ground in the center. But there is no marking on the component nor the PCB. Does this component have directionality?
